...
Recordings are unchanged Voice Memos `.m4a` files. Group each instrument in a
descriptive directory and use this filename pattern:

`<tuning>-string-<number>-<note>-<case>-<take>.m4a`

Examples:

- `original-guitar/standard-string-6-e2-in-tune-01.m4a`
- `harley-benton-les-paul/standard-string-6-e2-flat-20c-01.m4a`
- `harley-benton-les-paul/standard-string-1-e4-sharp-20c-01.m4a`
- `original-guitar/standard-string-5-a2-second-harmonic-01.m4a`
- `original-guitar/standard-string-3-g3-background-noise-01.m4a`
...
Sequence fixtures use the same instrument directory and:
